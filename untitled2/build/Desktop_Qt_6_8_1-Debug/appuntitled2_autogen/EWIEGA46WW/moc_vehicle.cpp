...
static constexpr auto qt_meta_stringdata_ZN7VehicleE = QtMocHelpers::stringData(
    "Vehicle"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7VehicleE[] = {
...
Q_CONSTINIT const QMetaObject Vehicle::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7VehicleE.offsetsAndSizes,
    qt_meta_data_ZN7VehicleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7VehicleE_t,
        // Q_OBJECT / Q_GADGET
...
void *Vehicle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7VehicleE.stringdata0))
